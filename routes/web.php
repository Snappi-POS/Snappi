...
use App\Livewire\Menu\MeasurementPage;
...
Route::middleware(['auth', config('jetstream.auth_session'), 'verified', 'clear.customer.language', LocaleMiddleware::class])->group(function () {
    ...
    Route::get('measurement', MeasurementPage::class)->name('measurement.index');
    ...
    Route::resource('purchases', PurchaseController::class)->except(['edit', 'update', 'show']);
