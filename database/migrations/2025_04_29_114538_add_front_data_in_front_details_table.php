    ...
    public function up(): void
    {
        ...
        foreach ($activeLanguages as $languageSetting) {
            ...
            FrontDetail::create([
                ...
                'header_title' => 'Business POS software made simple!',
                'header_description' => 'Easily manage stock, sales, and inventories in one place. Save time, reduce errors, and grow your business faster',
                'feature_with_image_heading' => 'Take Control of Your Business',
                'feature_with_icon_heading' => 'Powerful Features Built to Elevate Your Business Operations',
                'review_heading' => 'What Business Owners Are Saying',
                'price_heading' => 'Simple, Transparent Pricing',
                'price_description' => 'Get everything you need to manage your rusiness with one affordable plan.',
                'faq_heading' => 'Your questions, answered',
                'faq_description' => 'Answers to the most frequently asked questions.',
                'contact_heading' => 'Contact',
                'footer_copyright_text' => '© 2025 Ovendor. All Rights Reserved.',
                'created_at' => now(),
                'updated_at' => now(),
            ]);
            ...
            FrontFaq::insert([
                ...
                [
                    'language_setting_id' => $languageSetting->id,
                    'question' => 'Can I manage multiple locations with Ovendor?',
                    'answer' => 'Yes, Ovendor allows you to manage multiple restaurant locations from a single dashboard.',
                ],
                [
                    'language_setting_id' => $languageSetting->id,
                    'question' => 'Does Ovendor support online payments?',
                    'answer' => 'Absolutely. Ovendor integrates with leading payment gateways like Stripe and Razorpay for secure transactions.',
                ],
                [
                    'language_setting_id' => $languageSetting->id,
