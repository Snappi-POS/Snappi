    ...
    public function up(): void
    {
        ...
        foreach ($activeLanguages as $languageSetting) {
            ...
            FrontDetail::create([
                ...
                'footer_copyright_text' => '© 2025 Snappi. All Rights Reserved.',
                'created_at' => now(),
                'updated_at' => now(),
            ]);
            ...
            FrontFaq::insert([
                ...
                [
                    'language_setting_id' => $languageSetting->id,
                    'question' => 'Can I manage multiple locations with Snappi?',
                    'answer' => 'Yes, Snappi allows you to manage multiple restaurant locations from a single dashboard.',
                ],
                [
                    'language_setting_id' => $languageSetting->id,
                    'question' => 'Does Snappi support online payments?',
                    'answer' => 'Absolutely. Snappi integrates with leading payment gateways like Stripe and Razorpay for secure transactions.',
                ],
                [
                    'language_setting_id' => $languageSetting->id,
