...
<head>
    ...
    <link rel="icon" type="image/png" sizes="192x192"
          href="{{ global_setting()->upload_fav_icon_android_chrome_192_url }}">
    <link rel="icon" type="image/png" sizes="512x512"
          href="{{ global_setting()->upload_fav_icon_android_chrome_512_url }}">
            ...
            <div class="flex flex-wrap justify-between items-center mx-auto">
                ...
                <div class="hidden justify-between items-center w-full bg-gray-50 dark:bg-gray-700 mt-4 rounded-md"
                    ...
                    <ul class="flex flex-col font-medium ">
                        ...
                        <li>
                            <a href="{{ route('business_signup') }}" wire:navigate
