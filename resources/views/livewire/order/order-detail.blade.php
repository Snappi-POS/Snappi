        ...
        <x-slot name="title">
            ...
            <h2 class="flex justify-between text-lg">
                ...
                <div class="inline-flex items-center gap-1 text-sm text-gray-600 dark:text-gray-400">
                    <svg width="16" height="16" fill="currentColor" viewBox="0 -2.89 122.88 122.88" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="enable-background:new 0 0 122.88 117.09" xml:space="preserve">
            ...
            <div class="items-center justify-between gap-3 mt-4 space-y-1 lg:flex">
                <div class="inline-flex gap-4">
                    ...
                    <div @if(user_can('Update Order')) wire:click="$toggle('showTableModal')" @endif @class([ 'p-3 cursor-pointer rounded-lg tracking-wide bg-skin-base/[0.2] text-skin-base' , 'cursor-not-allowed'=> !user_can('Update Order'),
                        ])>
                ...
                <div>
                    <span @class([ 'text-xs font-medium px-2 py-1 rounded uppercase tracking-wide whitespace-nowrap' , 'bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-400 border border-gray-400'=>
                        $order->status == 'draft',
            ...
            <div class="py-4 mb-4 bg-white rounded-lg shadow-sm dark:bg-gray-800">
                ...
                <div class="flex flex-col space-y-4">
                    <div class="flex items-center justify-between text-gray-900 dark:text-white">
                        ...
                        <span
                            @class([ 'px-3 py-1 text-sm font-medium rounded-md' , 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300 border border-green-400'=>
                ...
                <table class="flex-1 min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700"
                        ...
                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <td class="p-2 text-base text-gray-900 whitespace-nowrap dark:text-gray-400">
                                @if ($item->receipt)
                                <a href="{{ asset('receipts/' . $item->receipt) }}" target="_blank"><img src="{{ asset('receipts/' . $item->receipt) }} " alt="Receipt" class="w-16 h-16 object-cover rounded-md mx-auto" ></a>
                                @else
                            ...
                            <td @class([ 'p-2 text-base text-gray-900 whitespace-nowrap text-center dark:text-gray-400' ,
                                ...
                                <div class="inline-flex items-center justify-center gap-2">
                                    ...
                                    @else
                                    <div @class([ 'inline-flex items-center gap-1 px-2 py-1 rounded text-sm' , 'bg-red-100 text-red-800 dark:bg-red-700 dark:text-red-400 border border-red-400'=> $item->payment_method == 'due',
                                        'bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-400 border border-gray-400' => $item->payment_method != 'due',
                                        ])>
                                        @php
                                        $icons = [
                                        'cash' => '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cash-stack" viewBox="0 0 16 16">
                                            <path d="M1 3a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1zm7 8a2 2 0 0 0 0-4 2 2 0 0 0 0 4" />
                                            <path d="M0 5a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1zm3 0a2 2 0 0 1-2 2v4a2 2 0 0 1 2 2h10a2 2 0 0 1 2-2V7a2 2 0 0 1-2-2h-1V3a2 2 0 0 0-2-2h-4a1 1 0 0 0-1 1v3M4 7h16" />
                                        </svg>',
                                        'upi' => '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-qr-code-scan" viewBox="0 0 16 16">
                                        ...
                                        'card' => '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-credit-card" viewBox="0 0 16 16">
            ...
            <div class="p-3 mt-3 rounded-lg bg-gray-50 dark:bg-gray-700">
                <div class="flex items-center justify-between mb-2">
                    ...
                    <a href="https://www.google.com/maps/dir/?api=1&travelmode=two-wheeler&origin={{ branch()->lat }},{{ branch()->lng }}&destination={{ $order->customer_lat }},{{ $order->customer_lng }}"
                        ...
                        <svg width="24" height="24" class="w-4 h-4" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 4H6a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-4m-8-2 8-8m0 0v5m0-5h-5" />
                        </svg>
                    </a>
                    @endif
                </div>
