<div>
    <div class="p-4 bg-white block  dark:bg-gray-800 dark:border-gray-700">
        <div class="flex mb-4">
            <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">@lang('menu.orders') ({{ $totalSalesCount }})</h1>
    ...
    <div class="flex flex-col my-4 px-4">
        ...
        <div class="space-y-4">
            ...
            <div class="flex border-b mb-4">
               ...
               {{ $activeTab === 'local' ? 'border-blue-600 text-blue-600' : 'border-transparent text-gray-600 hover:text-blue-500' }}">
                    Local ({{ $localCount }})
                </button>

                <button
                    wire:click="setActiveTab('online')"
                    class="ml-4 px-4 py-2 text-sm font-medium border-b-2 transition-colors duration-200 
               {{ $activeTab === 'online' ? 'border-blue-600 text-blue-600' : 'border-transparent text-gray-600 hover:text-blue-500' }}">
                    Online ({{ $onlineCount }})
                </button>
            </div>
