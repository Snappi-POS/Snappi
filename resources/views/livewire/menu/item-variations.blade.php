                    ...
                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700"
                            ...
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700"
                                ...
                                <td class="py-2.5 px-4 text-base text-center text-gray-900 whitespace-nowrap dark:text-white">
                                    {{ $item->quantity }}
                                </td>
            ...
            @if ($itemVariation)
                <form wire:submit="submitForm">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <x-label for="variationQuantity" value="{{ __('modules.menu.variationQuantity') }}" />
                            <x-input id="variationQuantity" class="block mt-1 w-full" type="number" wire:model='variationQuantity' />
                            <x-input-error for="variationQuantity" class="mt-2" />
                        </div>
