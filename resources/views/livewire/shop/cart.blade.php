<div>
    ...
    <div class="flex flex-col px-4 my-4" x-data="{ showAll: false }">
        ...
        <div class="grid grid-cols-2 gap-3 lg:grid-cols-4 sm:gap-4">
            ...
            <!-- All Menu Card -->
            <a @class([ 'group flex items-center border shadow-sm rounded-lg hover:shadow-md transition dark:bg-gray-700 dark:border-gray-600' , 'bg-skin-base dark:bg-skin-base'=> is_null($menuId),
                ...
                <div class="p-2 sm:p-3">
                    <div class="flex items-center gap-3">
                        ...
                        <div class="grow">
                            <h3 wire:loading.class.delay='opacity-50' @class([ 'font-semibold dark:group-hover:text-neutral-400 dark:text-neutral-200 text-xs lg:text-base' , 'text-gray-800 group-hover:text-skin-base'=> !is_null($menuId),
            ...
            <div x-show="showAll || {{ $index }} < 7" x-transition>
                <a @class([ 'group flex flex-col border shadow-sm rounded-lg hover:shadow-md transition dark:bg-gray-700 dark:border-gray-600 dark:hover:bg-gray-600' , 'bg-skin-base dark:bg-skin-base'=> $menuId == $item->id,
                    ...
                    <div class="p-2 sm:p-3">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="grow">
                                <h3 wire:loading.class.delay='opacity-50' @class([ 'font-semibold group-hover:text-skin-base dark:group-hover:text-gray-100 dark:text-neutral-200 text-xs lg:text-base' , 'text-gray-800 dark:text-gray-200'=> $menuId != $item->id,
                                    'text-white group-hover:text-white' => $menuId == $item->id,
                                    ])>
                                    {{ $item->getTranslation('menu_name', session('locale', app()->getLocale())) }}
                                </h3>
                                <p @class([ 'text-sm dark:text-neutral-500 hidden sm:block' , 'text-gray-500 dark:text-white'=> $menuId != $item->id,
        ...
        <div class="hidden p-2 rounded-md lg:block group bg-gray-50 dark:bg-gray-800">
            <nav class="flex gap-2 overflow-x-auto group-hover:[&::-webkit-scrollbar-thumb]:bg-gray-300 dark:group-hover:[&::-webkit-scrollbar-thumb]:bg-gray-600 [&::-webkit-scrollbar]:h-1.5 [&::-webkit-scrollbar-track]:hidden [&::-webkit-scrollbar-thumb]:rounded-full py-2" aria-label="Categories">
                <button wire:click="filterMenu(null)"
                    @class([ 'px-4 py-2 text-sm font-medium rounded-lg transition-colors whitespace-nowrap' , 'bg-skin-base text-white shadow-sm'=> is_null($filterCategories),
                ...
                <button wire:click="filterMenu({{ $item->id }})"
                    @class([ 'px-4 py-2 text-sm font-medium rounded-lg transition-colors inline-flex items-center gap-2 whitespace-nowrap' , 'bg-skin-base text-white shadow-sm'=> $filterCategories == $item->id,
    ...
    <div class="px-4 mb-32 space-y-4 lg:gap-8">
        ...
        <div class="space-y-4 lg:space-y-0 lg:grid lg:grid-cols-3 lg:gap-8">
            ...
            <div @class([ "flex items-center justify-between gap-6 border shadow-sm rounded-lg hover:shadow-md transition dark:border-gray-600 dark:lg:bg-gray-900 dark:shadow-sm lg:rounded-md" , "bg-gray-100 dark:bg-gray-800"=> !$item->in_stock,
    ...
    <div class="px-4 mt-4 space-y-4">
                        ...
                        <div class="flex flex-wrap items-center justify-between gap-3 sm:w-auto md:w-1/3">
                            ...
                            <div class="flex items-center">
                                <button type="button"
                                    ...
                                    <svg class="w-2 h-2 text-gray-900 dark:text-white" aria-hidden="true" viewBox="0 0 18 2">
                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 1h16" />
                                    </svg>
                                </button>
                                ...
                                <button type="button"
                                    ...
                                    <svg class="w-2 h-2 text-gray-900 dark:text-white" aria-hidden="true" viewBox="0 0 18 18">
                    ...
                    <div class="mt-2">
                        ...
                        <div class="flex items-center mt-2">
                            <span class="inline-flex items-center px-3 py-1.5 text-xs font-medium text-gray-600 bg-gray-100 rounded-full dark:bg-gray-700 dark:text-gray-300">
                                <svg class="w-3.5 h-3.5 mr-1.5" viewBox="0 0 24 24" stroke="currentColor" fill="none">
                        ...
                        <div x-data="{ showNoteInput: false, noteText: '' }" class="mt-2">
                            <button
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" class="w-3.5 h-3.5 group-hover:scale-110 transition-transform duration-200" xml:space="preserve">
                                    <path d="M11.3 26.5 4 28l1.5-7.3L21.6 4.5c.8-.8 2.1-.8 2.9 0l2.9 2.9c.8.8.8 2.1 0 2.9zm7.4-19 5.8 5.8m-5.8 0-8.8 8.8" style="fill:none;stroke:currentColor;stroke-width:2;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10" />
                                </svg>
                    ...
                    <div x-data="{ showNotes: false }" x-cloak>
                        ...
                        <div x-show="!showNotes && $wire.orderNote"
                            ...
                            <div class="flex items-center justify-between p-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700/50 dark:border-gray-600">
                                <!-- Note Icon & Text -->
                                <div class="flex items-center gap-3">
                                    <svg class="w-5 h-5 text-gray-400" width="24" height="24" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" d="M6 11h8V9H6zm0 4h8v-2H6zm0-8h4V5H6zm6-5H5.5A1.5 1.5 0 0 0 4 3.5v13A1.5 1.5 0 0 0 5.5 18h9a1.5 1.5 0 0 0 1.5-1.5V6z" fill="currentColor" />
                                    </svg>
                                ...
                                <button @click="showNotes = true" class="flex items-center gap-1.5 text-skin-base hover:text-skin-base/80 hover:scale-110 p-1">
                                    <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m15.232 5.232 3.536 3.536m-2.036-5.036a2.5 2.5 0 1 1 3.536 3.536L6.5 21.036H3v-3.572z" />
                                    </svg>
                                </button>
                            </div>
                        </div>
        ...
        <div class="p-4 text-center md:py-7 md:px-5">
            ...
            <a class="inline-flex items-center justify-center px-3 py-2 mt-3 text-sm font-medium text-white border border-transparent rounded-lg gap-x-2 bg-skin-base hover:bg-skin-base focus:outline-none disabled:opacity-50 disabled:pointer-events-none"
                href="{{ module_enabled('Subdomain') ? url('/') : route('business_page', [$restaurant->hash]) }}"
                wire:navigate>
                @lang('modules.order.placeOrder')
            </a>
        </div>
            ...
            <div class="col-span-2 space-y-8">
                ...
                <div class="flex flex-col gap-3 space-y-3 sm:gap-4"
                    ...
                    <div class="grid grid-cols-2 gap-3 md:grid-cols-4 sm:gap-4">
                        ...
                        <a @class([ 'group cursor-pointer flex items-center justify-center border shadow-sm rounded-lg hover:shadow-md transition dark:bg-gray-700 dark:border-gray-600' , 'bg-red-50'=> $item->status == 'inactive',
                            ...
                            <div class="p-3">
                                <div class="flex flex-col items-center justify-center space-y-2">
                                    ...
                                    @endif
                                    <div @class([ 'p-2 rounded-lg tracking-wide ' , ' bg-green-100 text-green-600'=> $item->available_status == 'available',
        ...
        <x-slot name="content">
            ...
            <div class="flex items-center mt-2">
                ...
                <div>
                    ...
                    @if ($image)
                    <div class="mt-3">
                        <img src="{{ $image->temporaryUrl() }}" alt="Preview" class="w-32 h-32 rounded-md object-cover border">
                    </div>
                    @endif
