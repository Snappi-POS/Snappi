<div class="mx-2 mb-4 space-y-6 md:mx-0" @if(pusherSettings()->is_enabled_pusher_broadcast) wire:poll.15s @endif>
                            ...
                            <div @class([
                                ...
                                <div @class([
                                    ...
                                    @if($index <= $currentStepIndex)
                                        <svg class="w-4 h-4 {{ $index < $currentStepIndex ? 'animate-checkmark' : '' }}"
                                    ...
                                    @else
                                        ...
                                        @switch($status)
                                            @case('placed')
                                                ...
                                                @break
                                            @case('confirmed')
                                                <svg class="w-4 h-4" viewBox="0 0 0.72 0.72"
                                                     xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                          d="M0.51 0.21a0.16 0.16 0 0 0 -0.155 -0.12 0.16 0.16 0 0 0 -0.155 0.12H0.09v0.36a0.06 0.06 0 0 0 0.06 0.06h0.42a0.06 0.06 0 0 0 0.06 -0.06V0.21zm-0.042 0a0.12 0.12 0 0 0 -0.226 0zM0.15 0.27h0.42v0.3H0.15z"
                                                          fill="currentColor"/>
                                                    <path d="m0.45 0.369 -0.021 -0.021L0.33 0.446 0.291 0.408l-0.021 0.021 0.06 0.06z"
                                                          fill="currentColor"/>
                                                </svg>
                                                @break
                                            @case('preparing')
                                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 7.68 7.68"
                                                     xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="p-3 mb-3 rounded-lg shadow-sm bg-gray-50 dark:bg-gray-800">
                    ...
                    @if($order->table_id)
                        <div class="flex items-center gap-1.5">
                            <svg class="w-3.5 h-3.5 text-gray-500 dark:text-gray-400" fill="none" stroke="currentColor"
                                 viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                      d="M9 3H5a2 2 0 0 0-2 2v4m6-6h10a2 2 0 0 1 2 2v4M3 9v8a2 2 0 0 0 2 2h4m-6-10h18M9 19h10a2 2 0 0 0 2-2V9"/>
                            </svg>
        ...
        @if($order->order_type === 'delivery' && $order->delivery_address)
            <div class="p-2 mt-3 rounded-lg bg-skin-base/5 dark:bg-gray-700/30" wire:key="delivery-address">
                <div class="flex items-center gap-2">
                    <svg class="flex-shrink-0 w-3.5 h-3.5 text-gray-600 dark:text-gray-400" fill="none"
                         stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                              d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0zm-2.657-5.657a3 3 0 11-6 0 3 3 0 016 0z"/>
                    </svg>
                                ...
                                <div class="space-y-1">
                                    <div class="flex flex-wrap items-center gap-1.5">
                                        <div class="inline-flex items-center text-sm font-semibold text-gray-900 dark:text-white">
                                            <img src="{{ asset('img/' . $item->menuItem->type . '.svg') }}"
                                                 class="h-3.5 mr-1.5"
                        ...
                        <div class="flex items-center justify-between gap-3 mt-2">
                            ...
                            <div class="flex items-center gap-2">
                                <div class="p-1.5 rounded-lg bg-skin-base/10">
                                    <svg class="w-3.5 h-3.5 text-skin-base" fill="none" stroke="currentColor"
                                         viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div class="p-3 my-3 shadow-sm bg-gray-50 dark:bg-gray-800 rounded-xl">
        ...
        <div class="flex items-center gap-2 mb-3">
            <svg class="w-5 h-5 text-gray-700 dark:text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                      d="M17 9V7a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h2m2 4h10a2 2 0 0 0 2-2v-6a2 2 0 0 0-2-2H9a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2m7-5a2 2 0 1 1-4 0 2 2 0 0 1 4 0"/>
            </svg>
                                    ...
                                    @switch($payment->payment_method)
                                        @case('stripe')
                                            <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"
                                                 width="24" height="24" fill="#6772e5">
                                        ...
                                        @case('paystack')
                                            ...
                                            @break
                                        @case('paypal')
                                            <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" aria-label="PayPal"
                                                ...
                                                <path fill="#009BE1"
                                                      d="M380.2 165c30 16 37 46 27 86-13 59-52 84-109 85l-16 1c-6 0-10 4-11 10l-13 79c-1 7-7 12-14 12h-60c-5 0-9-5-8-10l22-143c1-5 182-120 182-120"/>
                                                <path fill="#001F6B"
                                                      d="m197 292 20-127a14 14 0 0 1 13-11h96c23 0 40 4 54 11-5 44-26 115-128 117h-44c-5 0-10 4-11 10"/>
                                            </svg>
                                            @break
                                        @case('payfast')
                                            <svg class="w-5 h-5" width="24" height="24" viewBox="0 0 64 64"
                                        ...
                                        @case('flutterwave')
                                            <svg class="h-5 w-5" width="24" height="24"
                                                 xmlns="http://www.w3.org/2000/svg" viewBox="0 0 176 144.7"
                                                 xml:space="preserve"><path
                                                        ...
                                                        style="fill:#009a46"/>
                                                <path d="M63.1 144.7c-9.4 0-17.4-2.7-23.1-8.5l10-10c11.1 11.1 45.6 1.4 77.3-30.3s41.4-66.2 30.3-77.3l10-10c18.8 18.8 5.4 61.5-30.3 97.3-24.9 24.8-53.1 38.8-74.2 38.8"
                                                      style="fill:#ff5805"/>
                                                <path d="M140.5 91.6C134.4 74.1 122 55.4 105.6 39 69.8 3.2 27.1-10.1 8.3 8.6 7 10 8.2 13.3 10.9 16s6.1 3.9 7.4 2.6c11.1-11.1 45.6-1.4 77.3 30.3 15 15 26.2 31.8 31.6 47.3 4.7 13.6 4.3 24.6-1.2 30.1-1.3 1.3-.2 4.6 2.6 7.4s6.1 3.9 7.4 2.6c9.6-9.7 11.2-25.6 4.5-44.7"
                                                      style="fill:#f5afcb"/>
                                                <path d="M167.5 8.6C157.9-1 142-2.6 122.9 4c-17.5 6.1-36.2 18.5-52.6 34.9-35.8 35.8-49.1 78.5-30.3 97.3 1.3 1.3 4.7.2 7.4-2.6s3.9-6.1 2.6-7.4c-11.1-11.1-1.4-45.6 30.3-77.3 15-15 31.8-26.2 47.2-31.6 13.6-4.7 24.6-4.3 30.1 1.2 1.3 1.3 4.6.2 7.4-2.6s3.9-5.9 2.5-7.3"
                                                      style="fill:#ff9b00"/></svg>
                                            @break
                                        @case('upi')
                                            <svg class="w-5 h-5 text-gray-700 dark:text-gray-300" aria-hidden="true"
        ...
        @if($order->status == 'paid')
            ...
            <x-secondary-link wire:navigate class="inline-flex items-center justify-center w-1/2 gap-2"
                              href="{{ $newOrderLink }}">
                    ...
                    <div class="grid w-full grid-cols-2 gap-4">
                        @if ($paymentGateway->is_qr_payment_enabled || $paymentGateway->stripe_status || $paymentGateway->razorpay_status || $paymentGateway->is_offline_payment_enabled || $paymentGateway->flutterwave_status || $paymentGateway->paypal_status)
                            @if ($order && $order->order_status->value !== 'cancelled' && $order->status !== 'pending_verification')
                                <x-button class="items-center w-full" wire:click="InitializePayment"
                        ...
                        @endif
                        <x-secondary-link wire:navigate class="inline-flex items-center justify-center gap-2"
                                          href="{{ $newOrderLink }}">
                            @lang('modules.order.newOrder')
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <x-dialog-modal wire:model.live="showPaymentModal" maxWidth="md">
                ...
                <div class="mt-2">
                    ...
                    @else
                        <div class="flex items-center">
                                <span class="p-3 font-bold text-gray-700 rounded dark:text-gray-400">
                                    @lang('modules.billing.accountDetails')
                                </span>
                        ...
                        <div class="mt-2">
                            <label for="receipt-upload"
                                ...
                                <span wire:loading.remove wire:target="receipt">Upload Receipt</span>
                                <span wire:loading wire:target="receipt">Uploading...</span>
                            </label>
                            <input id="receipt-upload" type="file" wire:model="receipt" class="hidden">
                        </div>
                ...
                <div class="grid items-center w-full grid-cols-1 gap-4 mt-4 md:grid-cols-2">
                                    ...
                                    <span class="inline-flex items-center">
                                        <svg height="21" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 468 222.5"
                                             xml:space="preserve"><path
                                                    ...
                                                    style="fill-rule:evenodd;clip-rule:evenodd;fill:#635bff"/></svg>
                                    </span>
                        </x-secondary-button>
                    @endif
                    ...
                    @if ($paymentGateway->razorpay_status)
                        <x-secondary-button wire:click='initiatePayment({{ $paymentOrder->id }})'>
                                    <span class="inline-flex items-center">
                                        <svg height="21" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122.88 26.53"
                                             xml:space="preserve">
                                ...
                                <span class="inline-flex items-center">
                                    <svg class="h-5 dark:mix-blend-plus-lighter" xmlns="http://www.w3.org/2000/svg"
                                         viewBox="0 0 916.7 144.7"><path
                                                ...
                                                style="fill:#2a3362"/><path
                                                d="M0 31.6c0-9.4 2.7-17.4 8.5-23.1l10 10C7.4 29.6 17.1 64.1 48.8 95.8s66.2 41.4 77.3 30.3l10 10c-18.8 18.8-61.5 5.4-97.3-30.3C14 80.9 0 52.8 0 31.6"
                                                style="fill:#009a46"/><path
                        ...
                        <x-secondary-button wire:click='initiatePayfastPayment({{  $paymentOrder->id }})'>
                                    <span class="inline-flex items-center">
                                        <svg width="24" height="24" viewBox="0 0 24 24"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <path d="M8 6 L14 12 L8 18" fill="none" stroke="#E63950" stroke-width="2.5"
                    ...
                    @if ($paymentGateway->is_qr_payment_enabled && $paymentGateway->qr_code_image_url)
                        ...
                        <x-secondary-button wire:click="toggleQrCode">
                                    <span class="inline-flex items-center">
                                        <svg class="w-5 h-5" width="24" height="24" viewBox="0 0 24 24"
                                             fill="currentColor" xmlns="http://www.w3.org/2000/svg"><g
                                                    stroke-width="0"/><g stroke-linecap="round"
                                                                         stroke-linejoin="round"/><path fill="none"
                                                                                                        d="M0 0h24v24H0z"/><path
                                                    d="M16 17v-1h-3v-3h3v2h2v2h-1v2h-2v2h-2v-3h2v-1zm5 4h-4v-2h2v-2h2zM3 3h8v8H3zm2 2v4h4V5zm8-2h8v8h-8zm2 2v4h4V5zM3 13h8v8H3zm2 2v4h4v-4zm13-2h3v2h-3zM6 6h2v2H6zm0 10h2v2H6zM16 6h2v2h-2z"/></svg>
                        ...
                        <x-secondary-button wire:click="togglePaymentDetail">
                                    <span class="inline-flex items-center">
                                        <svg class="w-5 h-5" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <path d="M12 15V17M6 7H18C18.5523 7 19 7.44772 19 8V16C19 16.5523 18.5523 17 18 17H6C5.44772 17 5 16.5523 5 16V8C5 7.44772 5.44772 7 6 7ZM6 7L18 7C18.5523 7 19 6.55228 19 6V4C19 3.44772 18.5523 3 18 3H6C5.44772 3 5 3.44772 5 4V6C5 6.55228 5.44772 7 6 7Z"
                                ...
                                <span class="inline-flex items-center">
                                    <svg class="w-5 h-5 text-gray-800 dark:text-white" aria-hidden="true"
                                         ...
                                         viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round"
                                                                   stroke-width="2"
                                                                   d="M8 7V6a1 1 0 0 1 1-1h11a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1h-1M3 18v-7a1 1 0 0 1 1-1h11a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1Zm8-3.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Z"/></svg>
        ...
        <x-slot name="footer">
            ...
            @if ($showQrCode || $showPaymentDetail)
                @if(empty($receipt))
                    <x-button class="ml-3" disabled>@lang('modules.billing.paymentDone')</x-button>
                @else
                    <x-button class="ml-3"
