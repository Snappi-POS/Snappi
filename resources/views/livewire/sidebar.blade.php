            ...
            dark:hover:[&::-webkit-scrollbar-thumb]:bg-gray-400">
                <div
                    ...
                    <ul class="py-2 space-y-2">
                        ...
                        <x-sidebar-dropdown-menu :name='__("menu.menuStock")' icon='menu' :active='request()->routeIs(["menus.*", "menu-items.*", "item-categories.*", "item-modifiers.*", "modifier-groups.*",  "measurement.*",  "purchases.*", "stock-movements.*"])'>
