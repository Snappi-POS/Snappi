            ...
            <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
                <div
                    ...
                    <ul class="py-2 space-y-2">
                        ...
                        @livewire('sidebar-menu-item', ['name' => __('superadmin.menu.businesses'), 'icon' => 'restaurants', 'link' => route('superadmin.restaurants.index'), 'active' => request()->routeIs('superadmin.restaurants.*')])
