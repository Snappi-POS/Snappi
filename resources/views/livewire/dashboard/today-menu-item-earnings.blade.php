<div>
    <div
        ...
        <div class="w-full">
            <h3 class="text-base font-normal text-gray-500 dark:text-gray-400 mb-4">@lang('modules.dashboard.topDish')
                (@lang('app.today'))
            </h3>
                                ...
                                <div class="w-full max-w-smspace-y-2">
                                    <div>
                                        <div class="flex items-center gap-3">
                                            ...
                                            <img class="rounded-md object-cover h-10 w-10"
                                            ...
                                            <div>
                                                ...
                                                <span class="text-gray-600 dark:text-white text-xs">
                                                    {{ $item->orders->value('quantity') }} @lang('modules.order.qty')</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <footer class="mt-5">{{$menuItems->onEachSide(0)->links()}}</footer>
        </div>
