...
<head>
    <title>Snappi - Verify Purchase</title>
    ...
    <div class="container mx-auto px-4 py-6 max-w-2xl">
        <div class="flex flex-col items-center mb-12">
            <div class="flex items-center">
                <img src="{{ asset('img/logo.png') }}" class="h-12 w-auto" alt="Snappi Logo" />
                <h1 class="text-2xl font-bold ml-4 text-gray-800">Snappi</h1>
            </div>
        </div>
            ...
            $.easyAjax({
                ...
                success: function(response) {
                    if (response.status === 'success') {
                        ...
                        showError({
                            responseJSON: {
                                message: response.data.server.message
                            }
                        });
                    }
                },
