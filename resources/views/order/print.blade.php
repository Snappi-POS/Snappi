...
<body>
    <div class="receipt">
        <div class="header">
            ...
            <div class="restaurant-info">@lang('modules.customer.phone'): {{ \Illuminate\Support\Str::startsWith(restaurant()->phone_number, '0') ? restaurant()->phone_number : '0' . restaurant()->phone_number }}
</div>
            ...
            <tbody>
                @foreach ($order->items as $item)
                    <tr>
                        ...
                        <td class="price" style="padding-right:2px;text-align:left">
