...
class EditMenuItem extends Component
{
    ...
    public function mount()
    {
        ...
        $this->measurement_id =  $this->menuItem->measurement_id;
        $this->quantity_in_measure =  $this->menuItem->quantity_in_measure;
        $this->isSubMeasure = optional($this->menuItem->measurement)->submeasure ? true : false;
    ...
    public function submitForm()
    {
        $rules = [
            ...
            'quantity_in_measure' => 'required|integer|min:1',
        ];
        ...
        MenuItem::withoutGlobalScope(AvailableMenuItemScope::class)->where('id', $this->menuItem->id)->update([
            ...
            'quantity_in_measure' => $this->quantity_in_measure,
        ]);
