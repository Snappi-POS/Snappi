...
class RestaurantSignup extends Component
{
    ...
    public function submitForm2()
    {
        ...
        $branchHeadRole = Role::create(['name' => 'Branch Head_' . $restaurant->id, 'display_name' => 'Store Manager', 'guard_name' => 'web', 'restaurant_id' => $restaurant->id]);

        Role::create(['name' => 'Waiter_' . $restaurant->id, 'display_name' => 'Sales Staff', 'guard_name' => 'web', 'restaurant_id' => $restaurant->id]);
        Role::create(['name' => 'Chef_' . $restaurant->id, 'display_name' => 'Cashier', 'guard_name' => 'web', 'restaurant_id' => $restaurant->id]);
