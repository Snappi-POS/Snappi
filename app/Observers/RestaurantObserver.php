...
class RestaurantObserver
{
    ...
    public function addCurrencies($restaurant)
    {
        ...
        // Safely get default currency
$defaultCurrency = null;

if (global_setting()->defaultCurrency) {
    $defaultCurrency = Currency::where('currency_code', global_setting()->defaultCurrency->currency_code)
                               ->where('restaurant_id', $restaurant->id)
                               ->first();
}

// Fallback if no default currency found
if (!$defaultCurrency) {
    $defaultCurrency = Currency::where('restaurant_id', $restaurant->id)->first();
}

$restaurant->currency_id = $defaultCurrency->id ?? null;
