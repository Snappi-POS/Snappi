...
class LanguageSettingObserver
{
    ...
    public function detail($languageId)
    {
        ...
        $trFrontDetail->header_title = 'Business POS software made simple!';
        $trFrontDetail->header_description = 'Easily manage stock, sales, and inventories in one place. Save time, reduce errors, and grow your business faster';

        $trFrontDetail->feature_with_image_heading = 'Take Control of Your Business';
        $trFrontDetail->feature_with_icon_heading = 'Powerful Features Built to Elevate Your Business Operations';

        $trFrontDetail->review_heading = 'What Business Owners Are Saying';

        $trFrontDetail->price_heading = 'Simple, Transparent Pricing';
        $trFrontDetail->price_description = 'Get everything you need to manage your business with one affordable plan.';
    ...
    public function features($languageId)
    {
        $features = [
            [
                ...
                'title' => 'Streamline Sales Management',
