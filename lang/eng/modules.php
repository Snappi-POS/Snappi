...
return [
    'menu' => [
        ...
        'addMenu' => 'Add Brand',
        'menuName' => 'Brand Name',
        'menuQuantityAvailable' => 'Quantity',
        'allMenus' => 'Brands',
        'chooseMenu' => 'Choose Brand',
        'allMenuItems' => 'Products',
        'menuNameHelp' => 'Enter brand name of one of your products below to get started.',
        'item' => 'Item(s)',
        'addMenuItem' => 'Add Item',
        'editMenuItem' => 'Edit Brand Item',
        'itemCategory' => 'Item Category',
        'addItemCategory' => 'Add Item Category',
        'addMeasurement' => 'Add Unit Measurement',
        'typeVeg' => 'Veg',
        'addItem' => 'Add Item',
        'typeNonVeg' => 'Non Veg',
        'typeEgg' => 'Egg',
        ...
        'sortMenuItems' => 'Organize Brand Items',
        'sortManagerInfoMessage' => 'Drag and drop to organize brands, items and categories. Click a brand or category to filter and focus your item list.',
    ...
    'measurements' => [
        'mainMeasure' => 'Main Measurement',
        'subMeasure' => 'Sub Measurement',
        'measurement' => 'Unit Measurement',
        'quantityInMeasure' => 'Quantity in Measure',
        'initialQuantity' => 'Initial Quantity',
        'qty' => 'Quantity'
    ],

    'purchases' => [
        'purchaseTitle' => 'Product',
        'amount' => 'Amount',
    ...
    'settings' => [
        ...
        'restaurantInformation' => 'Business Information',
        'restaurantName' => 'Business Name',
        'restaurantPhoneNumber' => 'Business Phone Number',
        'restaurantEmailAddress' => 'Business Email Address',
        'restaurantAddress' => 'Business Address',
        'generalHelp' => 'Enter the general information about your business.',
        'countryTimezone' => 'Business\'s Country, Timezone & Currency',
        ...
        'restaurantSettings' => 'Business Information',
        'taxSettings' => 'Taxes',
        ...
        'upgradeLicenseInfo' => 'Simple, transparent pricing with everything you need to run your business smoothly.',
        'pricing' => 'Pricing',
        'payNow' => 'Pay Now',
        'paymentSource' => 'Payment Source',
        'appName' => 'App Name',
        'paymentUpgradeHeading' => 'Upgrade to Accept Payments Seamlessly',
        'paymentUpgradeInfo' => 'Take your business\'s efficiency to the next level by integrating Payment Gateways. Upgrade now to offer your customers secure, fast, and convenient payment options like Stripe and Razorpay',
        'themeUpgradeHeading' => 'Upgrade for a Personalized Brand Experience',
        'themeUpgradeInfo' => 'Stand out with your unique brand identity! Upgrade now to customize your Theme Colors and add your Business Logo, creating a seamless experience that reflects your business\'s personality.',
        ...
        'restaurantLogo' => 'Show Business Logo',
        'restaurantTax' => 'Show Business Tax',
        ...
        'showLogoText' => 'Show Business Name with Logo',
        ...
        'logoDescription' => 'Upload a logo for your business.',
        'showLogoTextDescription' => 'Enable this to show the business name with the logo.',
        ...
        'restaurantRequiresApproval' => 'Business Requires Approval',
        'restaurantRequiresApprovalInfo' => 'Enable this to require admin approval for new business registrations.',
        'themeColorDescription' => 'Select the theme color for your business.',
        ...
        'hideNewReservation' => 'Hide New Appointment',
        ...
        'hideNewReservationDescription' => 'Enable this to hide new appointment widget from top navigation.',
        ...
        'printerSettingDescription' => 'Configure printer settings for your business.',
        ...
        'enablePaystack' => 'Enable Paystack',
        'adminSettings' => 'Enable payment gateways to show in business panel',
    ...
    'delivery' => [
        ...
        'shopLocation' => 'The business location',
        ...
        'deliveryNotAvailable' => 'Delivery is not available at the moment. Please connect with the business directly for assistance.',
        ...
        'estimatedTimeUnavailable' => 'Estimated time unavailable. Please contact the shop owner for more details.',
    ...
    'dashboard' => [
        ...
        'totalPaidRestaurantCount' => 'Total Paid Business Count',
        'verificationPendingInfo' => 'Your business is pending verification. Please wait for admin approval.',
        'verificationPending' => 'Verification Pending',
        'verificationPendingDescription' => 'Business is waiting for approval',
    ...
    'update' => [
        ...
        'fileReplaceAlert' => 'To update the business to the new version check documentation for the instructions.',
    ...
    'reservation' => [
        ...
        'Cancelled' => 'Cancelled',
        'Pending' => 'Pending',
        'todayReservations' => 'Today Appointments',
        'newReservations' => 'New Appointments',
        'newReservation' => 'New Appointment',
        'selectDate' => 'Select Date of Booking',
        'upgradeHeading' => 'Unlock Seamless Table Reservations Today!',
        'upgradeInfo' => 'Effortlessly manage customer appointments. Upgrade now and give your customers the convenience they deserve, while streamlining your operations.',
        'reservedTables' => 'Appointments',
    ],

    'notifications' => [
        'order_received' => 'New Order Received',
        'order_received_info' => 'Business admin will receive an email when a new order is placed by the customer.',
        'reservation_confirmed' => 'Appointment Confirmation',
        'reservation_confirmed_info' => 'Customer will receive an email after making appointment.',
        'new_reservation' => 'New Appointment Received',
        'new_reservation_info' => 'Business admin will receive an email when a new appointment is made by the customer.',
    ...
    'onboarding' => [
        ...
        'addBranchInfo' => 'Provide the essential details of your business branch.',
        'addAreaHeading' => 'Set Up Your Business Areas',
        ...
        'addMenuHeading' => 'Build Your Brands',
        'addMenuInfo' => 'Let\'s build your product brands! First add a brand name to your brands like Mercedes, Emzor, Panasonic etc.',
        'addMenuItemHeading' => 'Add First Product to Your Brand',
        'addMenuItemInfo' => 'Hooray, you are almost done. Add your first product with its description and price to complete your shop setup.',
        'addOrderHeading' => 'Success. Now Add Your Products',
        'addOrderInfo' => 'Add brands, products, categories, unit measures and enjoy seamless sales.',
    ],

    'restaurant' => [
        'addRestaurant' => 'Add Business',
        'name' => 'Business Name',
        'email' => 'Email Address',
        'address' => 'Address',
        'editRestaurant' => 'Edit Business',
        'deleteRestaurant' => 'Delete Business',
        'deleteRestaurantMessage' => 'Are you sure you want to delete the business?',
        'logo' => 'Logo',
        'phone' => 'Phone',
        'restaurantDetails' => 'Business Details',
        'restaurantBranchDetails' => 'Add Business Branch Details',
    ...
    'report' => [
        ...
        'salesReportMessage' => 'Check and track your business\'s earnings',
